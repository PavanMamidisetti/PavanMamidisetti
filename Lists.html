...
<dt>JavaScript</dt>
<dd>A programming language used to create dynamic and interactive effects within web browsers.</dd>
...
<ul>
<li>Sub-item in an unordered list
<ol>
<li>Ordered sub-item in an unordered list</li>
<li>Another ordered sub-item</li>
</ol>
</li>
</ul>
</li>
<li>Another item with nested definition list
<dl>
...
<!---
PavanMamidisetti/PavanMamidisetti is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
